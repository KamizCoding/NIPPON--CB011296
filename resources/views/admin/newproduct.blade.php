        ...
        <div class="main-panel">
            <div class="content-wrapper">
             ...
             @endif
                ...
                <div class="centerdiv">
                    <h2 class="fonthead">Add A New Product</h2>
                </div>
                <div class="visacat">
                    <form class="form" action="{{ url('add_new_product') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="Country_Name">Country Name :</label>
                            <input class="input" type="text" name="Country_Name" placeholder="Enter Country Name" required>
                        </div>
                        <div class="form-group">
                            <label for="Visa_Description">Visa Description :</label>
                            <input class="input" type="text" name="Visa_Description" placeholder="Enter Visa Description" required>
                        </div>
                        <div class="form-group">
                            <label for="Visa_Fee">Visa Fee :</label>
                            <input class="input" type="number" name="Visa_Fee" placeholder="Enter The Visa Fee" required>
                        </div>
                        <div class="form-group">
                            <label for="Visa_Quantity">Visa Quantity :</label>
                            <input class="input" type="number" min="0" name="Visa_Quantity" placeholder="Enter Visa Quantity" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="input" type="file"  name="Visa_Image" required>
                        </div>
