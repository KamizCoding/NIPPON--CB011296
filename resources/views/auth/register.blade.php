<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="date_of_birth" value="{{ __('Birth Date: IN YYYY-MM-DD Format ') }}" />
                <x-input id="date_of_birth" class="block mt-1 w-full" type="text" name="date_of_birth" :value="old('date_of_birth')" required autocomplete="date_of_birth" />
            </div>

            <div class="mt-4">
                <x-label for="home_address" value="{{ __('Address') }}" />
